...
<body>
                ...
                <div class="d-lg-flex">
                    <div class="container">
                        <ul class="navbar-nav lead">
                            ...
                            <li class="nav-item mx-3">
                                <a href="./friends.php" class="nav-link active">Credits</a>
                            </li>
                            <li class="nav-item mx-3">
    ...
    <section class="p-5">
        <div class="container">
            <form method="post" action="../include/addAccount.php?q=<?php  ?>">
                <label for="name" class="sr-only">Name</label>
                <select name="name" class="form-control mb-3" id="name">
                    <?php
                    session_start();
                    include_once('../include/dbConn.php');
                    $sql = "SELECT accounts.name, accounts.aid FROM accounts, users WHERE users.uid=accounts.uid AND users.uid = '{$_SESSION['uid']}'";
